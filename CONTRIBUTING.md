Contributing to Hyperdash Coin Core
==================================

The Hyperdash Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hyperdash Coin Core project, and is not to be
confused with overall Hyperdash Coin Network Protocol consensus changes.

Whether a pull request is merged into Hyperdash Coin Core rests with the project merge
...
Patches that change Hyperdash Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hyperdash Coin consensus, it must have been
...
The project leader is the release manager for each Hyperdash Coin Core release.
