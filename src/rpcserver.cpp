...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Hyperdash Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Hyperdash Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hyperdash Coin features */
        {"hyperdashcoin", "masternode", &masternode, true, true, false},
        {"hyperdashcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"hyperdashcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hyperdashcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hyperdashcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hyperdashcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"hyperdashcoin", "startmasternode", &startmasternode, true, true, false},
        {"hyperdashcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hyperdashcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hyperdashcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hyperdashcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hyperdashcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hyperdashcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hyperdashcoin", "mnbudget", &mnbudget, true, true, false},
        {"hyperdashcoin", "preparebudget", &preparebudget, true, true, false},
        {"hyperdashcoin", "submitbudget", &submitbudget, true, true, false},
        {"hyperdashcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hyperdashcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hyperdashcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hyperdashcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hyperdashcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hyperdashcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hyperdashcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hyperdashcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"hyperdashcoin", "mnsync", &mnsync, true, true, false},
        {"hyperdashcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> hyperdashcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9183/\n";
}
