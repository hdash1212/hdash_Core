...
// Copyright (c) 2017-2018 The Hyperdash Coin developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is HDASH collateral - checking if valid masternode)
