...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hyperdash Coin Core hyperdashcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hyperdashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hyperdash coin transaction") + "\n" +
                               "  hyperdashcoin-tx [options] -create [commands]   " + _("Create hex-encoded hyperdash coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hyperdash coin transaction
