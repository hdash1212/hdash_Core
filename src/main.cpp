...
#if defined(NDEBUG)
#error "Hyperdash Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uhdash) are considered zero fee (for relaying and mining)
...
{
    RenameThread("hyperdashcoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // HDASH: We use certain sporks during IBD, so check to see if they are
