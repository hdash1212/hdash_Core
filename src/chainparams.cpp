...
// Copyright (c) 2017 The Hyperdash Coin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000005e6adbc6ebed68bed6c7bd8267c425618dc5a9eeee5c4ec1c22d8e1bddb"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1561453352, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Hyperdash Coin: 1 day
        nTargetSpacing = 2 * 60;  // Hyperdash Coin: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for HDASH
         ...
         */
        const char* pszTimestamp = "hyperdash Core";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1561453352;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1259273;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000005e6adbc6ebed68bed6c7bd8267c425618dc5a9eeee5c4ec1c22d8e1bddb"));
        assert(genesis.hashMerkleRoot == uint256("0xa0c0b876a5da8bb5c04177357b916d61e618f55b8f87f4401ec160bd299d756b"));
        ...
        // Hyperdash Coin addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 80);
        // Hyperdash Coin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // Hyperdash Coin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // Hyperdash Coin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Hyperdash Coin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Hyperdash Coin BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Hyperdash Coin: 1 day
        nTargetSpacing = 2 * 60;  // Hyperdash Coin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xafa55c8c0a79fcf4a2261ebc09a5e971d0f5a1e3372c93332780a66e648e94e1"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet Hyperdash Coin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet Hyperdash Coin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Hyperdash Coin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Hyperdash Coin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet hyperdash coin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Hyperdash Coin: 1 day
        nTargetSpacing = 2 * 60;        // Hyperdash Coin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1531985875;
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 29835;
        assert(hashGenesisBlock == uint256("0xcf97fa97f0eca60bca7a138d10a839bb0d0aefd40061d356ff1f5a92d961a31e"));
