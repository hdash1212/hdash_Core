...
/** Utility functions used by the HyperdashCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render HDASH addresses in monospace font
...
// Parse "hyperdashcoin:" URI into recipient object, return true on successful parsing
