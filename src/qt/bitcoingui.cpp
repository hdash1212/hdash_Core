                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hyperdash Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HDASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hyperdashcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hyperdash Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hyperdash Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hyperdash Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HDASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HDASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a hyperdashcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hyperdash Coin Core help message to get a list with possible Hyperdash Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hyperdash Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hyperdash Coin network", "", count));
}
...
{
    QString strTitle = tr("Hyperdash Coin Core"); // default title
    ...
    // Append title to "Hyperdash Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
