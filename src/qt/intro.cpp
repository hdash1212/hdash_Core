...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hyperdash Coin Core"),
     ...
     * override -datadir in the hyperdashcoin.conf file in the default data directory
     * (to be consistent with hyperdashcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
