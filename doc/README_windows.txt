...
Intro
-----
Hyperdash Coin (HDASH) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Hyperdash Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run hyperdashcoin-qt.exe.

Hyperdash Coin Core is the original Hyperdash Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Hyperdash Coin transactions;
