...
In order to support loading of multiple wallets in hyperdashcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hyperdashcoin.cpp.
...
Changes to hyperdashcoin.cpp
----------------------
hyperdashcoin.cpp is the entry point into hyperdashcoin-qt, and as such, will require some minor modifications to provide hooks for
