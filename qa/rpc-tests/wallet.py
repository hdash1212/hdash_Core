...
#   c) node1 mines 32 blocks, so now node 0 has 500000HDASH, node 1 has 4250HDASH, node2 has none.
#   d) node0 sends 601 HDASH to node2, in two transactions (301 HDASH, then 300 HDASH).
